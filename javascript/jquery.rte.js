/*
 * Lightweight RTE - jQuery Plugin, version 1.3 (Edited by Will Mason 5/25/09)
...
jQuery.fn.rte = function(options, editors) {
	...
	$(this).each(function(i) {
		var id = (this.id) ? this.id : editors.length - 1;
...
lwRTE.prototype.enable_design_mode = function() {
	...
	$(self.iframe_doc).keyup(function(event) {
		if ($.isFunction(self.change))
			self.change.apply(this, []);
