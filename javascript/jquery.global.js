/*!
 * jQuery Globalization Plugin v1.0.0pre edited by WHMason 2011-05-14
...
function getTokenRegExp() {
    ...
    // TT & T added by WHMason 2011-05-14
    return /\/|dddd|ddd|dd|d|MMMM|MMM|MM|M|yyyy|yy|y|hh|h|HH|H|mm|m|ss|s|TT|T|tt|t|fff|ff|f|zzz|zz|z|gg|g/g;
}
        ...
        if ( matchGroup ) {
            ...
            switch ( current ) {
                ...
                case 's': case 'ss':
                    ...
                    break;
                case 'tt': case 't':
                case 'TT': case 'T': //added by WHMason 2011-05-14
                    // AM/PM designator.
    ...
    for (;;) {
        ...
        switch ( current ) {
            ...
            case "tt":
                ...
                part = value.getHours() < 12 ? (cal.AM ? cal.AM[1] : " ") : (cal.PM ? cal.PM[1] : " ");
                ret.push( clength === 1 ? part.charAt( 0 ) : part );
                break;
            case "T": //added by WHMason 2011-05-14
                // One character am/pm indicator ("a" or "p")
            case "TT":
                // Multicharacter am/pm indicator
